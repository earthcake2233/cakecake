...
} from "@/utils/cakecakeTokenRefresh";
...
const routes = [
  ...
  },
  {
    path: "/cakecake/login",
    name: "cakecakeLogin",
    component: () => import("@/pages/cakecake/Login.vue"),
    meta: { title: "cakecake 登录" }
  },
  {
    path: "/cakecake/register",
    name: "cakecakeRegister",
    component: () => import("@/pages/cakecake/Register.vue"),
    meta: { title: "cakecake 注册" }
  },
  {
    name: "cakecakeMessages",
    path: "/cakecake/messages",
    component: () => import("@/pages/cakecake/Messages.vue"),
    meta: { title: "cakecake 消息", requireCakecakeAuth: true }
  },
  {
    name: "cakecakePersonalCenter",
    path: "/cakecake/account",
    component: () => import("@/pages/cakecake/PersonalCenter.vue"),
    meta: { title: "个人中心 - cakecake", requireCakecakeAuth: true }
  },
  {
    name: "cakecakeUserSpace",
    path: "/cakecake/up/:userId",
    component: () => import("@/pages/cakecake/PersonalSpace.vue"),
    meta: { title: "个人空间 - cakecake" }
  },
  {
    name: "cakecakeUserSpaceRelations",
    path: "/cakecake/up/:userId/relations",
    component: () => import("@/pages/cakecake/SpaceRelations.vue"),
    meta: { title: "关注与粉丝 - cakecake" }
  },
  {
    name: "cakecakeWatchLater",
    path: "/cakecake/watch-later",
    component: () => import("@/pages/cakecake/WatchLater.vue"),
    meta: { title: "稍后再看 - cakecake" }
  },
  {
    name: "cakecakeDynamics",
    path: "/cakecake/dynamics",
    component: () => import("@/pages/cakecake/Dynamics.vue"),
    meta: { title: "动态 - cakecake", requireCakecakeAuth: true }
  },
  {
    name: "cakecakeArticleRead",
    path: "/cakecake/article/:id",
    component: () => import("@/pages/cakecake/ArticleRead.vue"),
    meta: { title: "专栏 - cakecake" }
  },
  {
    name: "cakecakeDynamicRead",
    path: "/cakecake/dynamic/:id",
    component: () => import("@/pages/cakecake/ArticleRead.vue"),
    meta: { title: "动态 - cakecake" }
  },
  {
    name: "cakecakeViewHistory",
    path: "/cakecake/history",
    component: () => import("@/pages/cakecake/ViewHistory.vue"),
    meta: { title: "历史记录 - cakecake", requireCakecakeAuth: true }
  },
  {
    name: "cakecakeUpload",
    path: "/cakecake/upload",
    component: () => import("@/pages/cakecake/Upload.vue"),
    meta: { title: "cakecake 上传", requireCakecakeAuth: true }
  },
  {
    path: "/admin/login",
    name: "adminLogin",
...
router.beforeEach(async (to, _from, next) => {
  ...
  const need = to.matched.some(
    r => r.meta && r.meta.requireCakecakeAuth === true
  );
