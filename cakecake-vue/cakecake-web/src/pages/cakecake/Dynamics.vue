...
export default {
  ...
  computed: {
    ...
    mySpaceRoute() {
      ...
      return cakecakeUserSpaceRoute(this.me.user_id);
    },
    mySpaceDynamicRoute() {
    ...
    relationsFollowingRoute() {
      if (!this.me) return null;
      return cakecakeUserSpaceRelationsRoute(this.me.user_id, "following");
    },
    relationsFollowersRoute() {
      if (!this.me) return null;
      return cakecakeUserSpaceRelationsRoute(this.me.user_id, "followers");
    },
    visibleFeed() {
  ...
  methods: {
    ...
    userSpaceDynamicRoute(userId) {
      return cakecakeUserSpaceDynamicRoute(userId);
    },
    formatDynDateCN(ts) {
      const d = new Date(ts);
