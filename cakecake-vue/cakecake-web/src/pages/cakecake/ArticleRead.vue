...
import MbDynamicEditDialog from "@/components/cakecake/MbDynamicEditDialog.vue";
import {
  mbGetArticle,
  mbGetUserDynamic,
  mbPostArticleView,
...
export default {
  ...
  computed: {
    ...
    isDynamic() {
      return this.$route.name === "cakecakeDynamicRead";
    },
    contentId() {
    ...
    authorRoute() {
      ...
      return cakecakeUserSpaceRoute(this.article.user_id);
    },
    publishedLabel() {
