  ...
  <div class="mb-cmt" :class="{ 'mb-cmt--embedded': embedded }">
    ...
    >
      ...
      >
        ...
        >
                <MbUserHoverCard
                  v-if="isCakecake && cmtHoverUid(row.root)"
          ...
          <div class="vd-cmt-body">
            ...
            <ul v-if="row.replyRows.length" class="vd-cmt-replies">
              ...
              >
                <MbUserHoverCard
                  v-if="isCakecake && cmtHoverUid(rr.c)"
...
import MbUserHoverCard from "@/components/cakecake/MbUserHoverCard.vue";
...
import { MB_COMMENT_PENDING_TOAST } from "@/constants/cakecakeComments";
...
export default {
  ...
  methods: {
    ...
    userSpaceRoute(userId) {
      return cakecakeUserSpaceRoute(userId);
    },
    ipLabel(c) {
      const loc =
